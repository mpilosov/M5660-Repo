...
mode = 'hybrid'                    # Choose mode. orig / mod / hybrid

choose_root = 20                 # choose a random root
multiplicity = 5                # choose multiplicity of root at x = 0
...
class fun:
    ...
    def iterate_hybrid_Newton(self,x):
        ...
        if self.rate is not None and self.old_rate is not None and self.calls>5:
            ...
            if self.rate/self.old_rate > 1-1E-2:
